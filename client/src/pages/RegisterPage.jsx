...
export default function RegisterPage() {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'absolute', top: '15%', right: '10%', width: 350, height: 350, borderRadius: '50%', background: '#A78BFA', opacity: 0.08, filter: 'blur(80px)' }} />
      <div style={{ position: 'absolute', bottom: '15%', left: '10%', width: 300, height: 300, borderRadius: '50%', background: '#86BBBD', opacity: 0.08, filter: 'blur(60px)' }} />
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '14px' }}>Create your VELA account. Free forever.</p>
        </div>

        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div>
            <label style={{ display: 'block', fontSize: '13px', fontWeight: 500, color: 'var(--text-secondary)', marginBottom: '6px' }}>Username</label>
            <div style={{ position: 'relative' }}>
              <HiUser style={{ position: 'absolute', left: 14, top: '50%', transform: 'translateY(-50%)', color: 'var(--text-muted)', fontSize: 18 }} />
              <input
                type="text"
                value={form.username}
          ...
          >
            {loading ? 'Creating account...' : 'Join VELA 🌟'}
          </motion.button>
        </form>
